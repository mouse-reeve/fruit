function fruit_fact(name, params) {
    ...
    var grammar_data = {
        'start': [
            ...
            '#name# #edible_part# #description#',
            '#name# #edible_part# #description#',
            'The #name# is #always# #preparation#',
            'The #name# is #always# #preparation#',
            'The #name# is #always# #preparation#',
            'The #name# is #always# #preparation#',
            'The #name# is #always# #preparation#',
        ...
        'pit': pit,
        'misc': [
            'The #inedible_part# of the #name# is not biodegradable',
            'Do not eat #name#',
            'The #name# is now extinct',
            '#name# is a sign of ill fortune.',
            '#name# brings good luck',
            'It is a crime to cultivate #name#',
        ],
        'baked_good': [
            'fresh fruit tart',
            'loaf cake',
        ...
        'origin': [
            ...
            'is a genetically engineered crop',
            'is an heirloom crop',
